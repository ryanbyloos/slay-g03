...
/**
 * Menu principal a partir duquel les divers menu sont accessibles.
 */
public class Home implements Screen {
    ...
    public void show() {
        ...
        TextButton playButton = new TextButton("PLAY", Slay.game.skin);
        ...
        addToTable(table, playButton, replayButton, hofButton, settingsButton, quitButton);
    }
